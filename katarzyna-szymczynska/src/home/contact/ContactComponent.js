...
function ContactComponent() {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_nkd8q7m', 'template_vpdiqlm', "#contact-form", 'kqvYLGrSXkzKPXAZo')
            .then((result) => {
    ...
    return (
        <Stack className='contact-content'>
            ...
            <Form ref={form} className='contact-form' noValidate validated={validated} onSubmit={handleSubmit} id="contact-form">
                <div className='shape-div'>
