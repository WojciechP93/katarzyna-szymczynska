      ...
      <Container fluid className='main-container' >
        <Row>
          <Routes>
            ...
            <Route path="/portfolio/ui-ux-and-web-design-component" element={<SubjectComponent items={uiux} subjectTitle="UI/UX and web design" />} />
            <Route path="/portfolio/ui-ux-and-web-design-component/equi-app" element={<GaleryComponent images={equiapp} subjectPath="ui-ux-and-web-design-component" subjectName="UI/UX and web design" />} />
          </Routes>
        </Row>
      </Container>
    </BrowserRouter>
